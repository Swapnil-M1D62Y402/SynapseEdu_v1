...
const PYTHON_BACKEND = "http://localhost:8005"; // replace with actual Python backend URL
...
export default {chatRag, createMcq, createFlashcard, createTest, summarizeText};
